...
This program would solve the lack of free to use audio-to-text software apps that are publicly available. I am a student who requires one of these programs to properly study in college. However, the program I use
...
My goal with this software is to try to make my own free version so my friends could have something they could use, since they are not able to get the paid versions of these apps. 

**Features**

The major features include audio recording, audio uploading, audio transcription, timed notes, bookmarking, organization of audio into folders, and summaries of transcriptions. The tools and languages required are Node.js, Express, SQLite, multer, fast-whisper, FFmpeg, HTML, CSS, JS, python, and VS Code. 
